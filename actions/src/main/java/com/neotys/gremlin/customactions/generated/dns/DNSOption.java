...
public enum DNSOption implements GremlinOption {
  ...
  IP_ADDRESSES("IP Addresses", Optional, False, TEXT, "", "Prevent lookups from these DNS servers\n"
  ...
  PROTOCOL("Protocol", Optional, False, TEXT, "", "Impact traffic only for this protocol\n"
