...
public class CPUAction extends GremlinAction {
  @Override
  ...
  public String getCustomArgsDescription() {
    return "Consumes CPU resources\n"
            + "https://www.gremlin.com/docs/infrastructure-layer/attacks/cpu\n"
            + "\n" + Arguments.getArgumentDescriptions(CPUOption.values());
  }

  @Override
  public List<ActionParameter> getCustomActionParameters() {
    return Arrays.stream(CPUOption.values()).filter(o -> Option.AppearsByDefault.True.equals(o.getAppearsByDefault())).map(o -> new ActionParameter(o.getName(), o.getDefaultValue(),o.getType())).collect(Collectors.toList());
  }

  @Override
  public Class<? extends ActionEngine> getEngineClass() {
    return CPUEngine.class;
  }
}
