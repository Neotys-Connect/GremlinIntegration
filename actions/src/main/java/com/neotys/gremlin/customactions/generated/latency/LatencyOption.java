...
public enum LatencyOption implements GremlinOption {
  ...
  MS("MS", Optional, False, TEXT, "100", "How long to delay egress packets (millis)\n"
      + "Value must be of type: Integer", new ArgumentValidator() {
    @Override
    public String getErrorMessage() {
      return "Value should be a Integer\n"
  ...
  LatencyOption(final String name,
