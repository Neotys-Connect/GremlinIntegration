...
public enum PacketLossOption implements GremlinOption {
  ...
  REMOTE_PORTS("Remote Ports", Optional, False, TEXT, "^53", "Only impact outgoing traffic to these remote ports\n"
      + "Ranges work too: '8080-8085'\n"
      + "Value must be of type: String", ALWAYS_VALID,"-p"),

  LOCAL_PORTS("Local Ports", Optional, False, TEXT, "", "Only impact outgoing traffic from these local ports\n"
      + "Ranges work too: '8080-8085'\n"
      + "Value must be of type: String", ALWAYS_VALID,"-s"),

  PERCENT("Percent", Optional, False, TEXT, "1", "Percentage of packets to drop (10 is 10%)\n"
      + "Value must be of type: Integer", new ArgumentValidator() {
    @Override
    public String getErrorMessage() {
      return "Value should be a Integer\n"
  ...
  CORRUPT("Corrupt", Optional, Hided, TEXT, "false", "Corrupt the packets instead of just dropping them.\n"
  ...
  PacketLossOption(final String name,
